...
//Output messages
    ...
    var outOfRange = "Way off!!!! Pick between 1 and 10."; //The specifications uses the message - Way off!!!! Pick between 1 and 10.
...
//Validate input and assign a return message
    ...
    } else if (guess < 1 || guess > 10) { //The specifications say guess a number between 1 and 10 (inclusive)
